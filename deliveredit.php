...
if (isset($_GET['sid'])) {
    $sid = $_GET['sid'];
    $query = "SELECT * FROM pdeliver WHERE sid = '$sid'";
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="form-group col-md-3">
                      ...
                      <input type="text" class="form-control" value="<?php echo $pdatetime; ?>" disabled>
                    </div>

                    
                    <div class="form-group col-md-5">
                      <label for="pdelivername">Deliver Person Name</label>
                      <input type="text" class="form-control" value="<?php echo $pdelivername; ?>" disabled>
                    </div>

                    
                    <div class="form-group col-md-3">
                      <label for="pamount">Amount</label>
                      <input type="text" class="form-control" value="<?php echo $pamount; ?>" disabled>
                    </div>
              ...
              if (isset($_POST['UpdateNote'])) {
                  ...
                  $updateQuery = "UPDATE pdeliver SET snote = '$updatedNote' WHERE sid = '$sid'";
