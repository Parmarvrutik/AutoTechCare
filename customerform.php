...
$ccity = $_POST['ccity'];
  // fetch mobile
  $result1 = mysqli_query($link,"Select * From customer where cnumber='$cnumber'");
  ...
  {
    $result = mysqli_query($link,"Insert into customer(cname,cnumber,ccity) values('$cname','$cnumber','$ccity')");
    mysqli_close($link);
